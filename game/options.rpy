...
define config.name = _("Reloaded_Gaming_Girls")
...
define build.name = "Reloaded_Gaming_Girls"
...
define config.main_menu_music = "<loop 4.32>audio/mainmenunew.mp3"
...
define config.save_directory = "Reloaded_Gaming_Girls-1728361484"
